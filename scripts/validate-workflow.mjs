...
// route.js imports
check('route.js → callAI', fileContains('src/app/api/summarize/route.js', "import { callAI }"), 'Missing callAI import');
check('route.js → promptStore', fileContains('src/app/api/summarize/route.js', "import { getPrompt"), 'Missing promptStore import');
check('route.js → workflowEngine', fileContains('src/app/api/summarize/route.js', "import { getWorkflow"), 'Missing workflowEngine import');
check('route.js → MasterAgent', fileContains('src/app/api/summarize/route.js', "import { MasterAgent }"), 'Missing MasterAgent import');
check('route.js → aiRouter', fileContains('src/app/api/summarize/route.js', "import { callSmartAI"), 'Missing aiRouter import');
check('route.js → moderationAgent', fileContains('src/app/api/summarize/route.js', "import { moderateVersions }"), 'Missing moderationAgent import');
...
const routeContent = fileExists('src/app/api/summarize/route.js') 
  ? readFileSync(resolve(ROOT, 'src/app/api/summarize/route.js'), 'utf-8') : '';
