...
{"newsType":"ประเภทข่าว","selectedIndex":เลขindex,"matchType":"exact หรือ closest","reason":"เหตุผลการเลือก"}`
      ...
      // === Inject Advanced Anti-Duplicate System (บังคับทุกครั้ง — ห้ามละเมิด) ===
      const quoteSafetyRule = `

=== ADVANCED ANTI-DUPLICATE SYSTEM — กฎบังคับสูงสุด (ห้ามละเมิด) ===

━━━ SIMILARITY ENGINE ━━━
ก่อนส่ง ตรวจทุกย่อหน้าว่า:
...
━━━ SIMILARITY CHECKLIST (ตรวจก่อนส่งทุกครั้ง) ━━━
1. ถ้าปิดชื่อคนออก จะดูเหมือนต้นฉบับไหม?
2. คนอ่านจะรู้ทันทีว่า rewrite จากข่าวเดียวกันไหม?
3. มี quote เดิมเยอะเกินไปไหม?
4. มีจังหวะเล่าเหมือนต้นฉบับไหม?
5. มี pattern "เปลี่ยนแค่คำ" ไหม?
6. อ่านแล้วเหมือน "ข่าวใหม่" จริงไหม?
→ ถ้าคำตอบใดคือ "ใช่" ให้ rewrite ใหม่ทันที

━━━ FORBIDDEN REWRITE PATTERNS ━━━
❌ เปลี่ยน synonym เล็กน้อย
❌ เติมคำหน้า/ท้าย
❌ ตัดบางคำออก
❌ สลับตำแหน่งคำเล็กน้อย
❌ เปลี่ยนจาก "เขาบอก" เป็น "เขาเผย" แล้วโครงสร้างเดิมทุกอย่าง
ตัวอย่างผิด: ต้นฉบับ "มันไม่แฟร์ที่ผู้หญิงจะต้องแต่งงานโดยไม่รู้ความจริง"
→ ❌ "เขามองว่ามันไม่แฟร์ที่ผู้หญิงจะต้องแต่งงานโดยไม่รู้ความจริง" (structure เดิม)
→ ✅ "เขาเชื่อว่าความสัมพันธ์ไม่ควรเริ่มต้นจากเรื่องที่อีกฝ่ายไม่เคยรู้มาก่อน"

━━━ QUOTE REWRITE ENGINE ━━━
• quote ตรงรวมกันห้ามเกิน 10% ของบทความ
• quote ตรงแต่ละก้อนไม่เกิน 8–15 คำ
• ห้ามเปิดบทความด้วย quote ยาว
• ห้ามมี quote ตรงติดกันหลายย่อหน้า

วิธีจัดการ quote ยาว:
1. เก็บเฉพาะ keyword สำคัญ
2. สรุป "ความหมาย" ใหม่
3. เปลี่ยนโครงสร้างทั้งหมด รักษาเจตนาเดิม

QUOTE SAFETY RULE (ห้ามบิดเบือนเด็ดขาด):
✅ ยก quote สั้นๆ เช่น "ถ้าโดนก็หล่น" / "ไม่มีคำว่าแพ้"
✅ สรุปความใหม่: "เขายืนยันว่าคืนนี้ขึ้นเวทีแบบไม่คิดถอย"
✅ ใช้รูปแบบ: เจ้าตัวยอมรับว่า "..." / เขาทิ้งท้ายว่า "..."
❌ ห้ามแต่งคำพูดให้แรงกว่าเดิม
❌ ห้ามเติมอารมณ์ที่เจ้าตัวไม่ได้พูด
❌ ห้ามสร้าง quote ปลอม

━━━ NARRATIVE ENGINE — เลือก Angle ใหม่ก่อนเขียนเสมอ ━━━
ห้ามเล่าเรียงตาม timeline ต้นฉบับ ห้ามสรุปทีละย่อหน้าแบบข่าวทีวี

เลือก Narrative Angle 1–3 มุม เช่น:
• มุมคนพยายามเตือน / มุมผลกระทบทางจิตใจ
• มุมคนรอบตัวที่โดนผลกระทบ / มุมความสัมพันธ์ที่เปลี่ยนไป
• มุมแรงกดดันจากสังคม / มุม consequence หลังเรื่องกลายเป็นข่าว
• มุมความจริงที่ถูกพูดช้าเกินไป

━━━ EDITORIAL THINKING MODE ━━━
ถามตัวเองก่อนเขียนว่า: "ถ้าบรรณาธิการเพจไวรัลเป็นคนเล่า เขาจะหยิบประเด็นไหนมาเป็นแกน?"
ต้องเลือก: emotional angle / social angle / conflict angle / consequence angle
แล้วค่อยเขียน — ห้ามสรุปข่าวตรงๆ ห้าม rewrite line-by-line

━━━ ANTI-STRUCTURE COPY ━━━
ต้นฉบับ: A→B→C→D
❌ ห้าม: A→B→C→D (แม้เปลี่ยนคำแล้ว)
✅ ให้สลับโครงสร้าง เช่น เปิดด้วยผลกระทบ/อารมณ์/consequence/conflict/moment สำคัญ

เขียนเหมือน: นักเล่าข่าวไวรัล / storyteller / columnist / มนุษย์ที่เข้าใจอารมณ์คน
ไม่ใช่: bot rewrite / AI summarize / โปรแกรมเปลี่ยนคำ

━━━ FINAL QUALITY CHECK (ตรวจก่อนส่ง) ━━━
□ มี quote ตรงเกิน 10% ไหม
□ มี sentence ไหนคล้ายต้นฉบับเกินไปไหม
□ มีการเรียง flow เดิมไหม
□ มี narrative ใหม่จริงไหม
□ มี emotional interpretation ไหม
□ มี editorial thinking ไหม
□ อ่านแล้วเหมือนมนุษย์ไหม
□ เอาต้นฉบับเทียบแล้วดูเหมือน "คนละบทความ" ไหม
→ ถ้ายังคล้าย: rewrite ใหม่ทันที

=== จบ ADVANCED ANTI-DUPLICATE SYSTEM ===
`;
      prompt += quoteSafetyRule;
      console.log('[Analyze] ✅ Advanced Anti-Duplicate System injected');
