...
export async function GET(request) {
  try {
    ...
    if (view === 'report') {
      ...
      //   ★ 23 ก.ย. 69 (เจ้าของสั่ง): opus-4-8 → opus-5-5 — เปลี่ยนเฉพาะชื่อรุ่นในป้าย note · ตัวเลข usd คงเดิม
      //     (5.5 ถูกกว่าต่อโทเคน 20% แต่คิดก่อนตอบเสมอ → โทเคนออกน่าจะเพิ่ม — รอวัดจากล็อกจริงก่อนปรับเรต)
      const RATES = {
        news: { usd: 0.28, label: 'ข่าว 1 งาน (2 เวอร์ชัน)', note: 'สกัด+แตกประเด็น terra+เขียน opus-5-5 ×2 มุม+เกลา ≈ 10-15 AI calls' },
