...
async function _renderCoverV3(request) {
  ...
  try {
    ...
    // ★ 27 มิ.ย. (แก้ "ไม่นิ่ง"): ตัด vt_hero_stack ออก — ช่อง clip กรอบเขียวซ้อนทำให้ "ภาพซ้อน/ขอบแหว่ง" (QC ติ clean=false)
    //   เหลือ vt_ref_tri (3 ขวาสะอาด ไม่ซ้อน = CASE-215/206/212) เป็นหลัก → เลย์เอาต์นิ่งทุกรอบ
    const fivePlusTemplates = [
      V3_TEMPLATES.vt_ref_tri,      // ★★ หลัก: hero + ขวา 3 สะอาด + วงกลมทอง (สะอาดสุด ไม่ซ้อน)
