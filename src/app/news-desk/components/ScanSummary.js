    ...
    <div style={{ display: 'grid', gap: 16 }}>
      ...
      <Card>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 10 }}>
          {[
            { key: 'primary', name: 'gpt-5.6-sol', tag: '★ แนะนำ', desc: 'คุณภาพสูงสุด วิเคราะห์ลึก', color: UI.accent, price: '฿1.1/ใบ' },
            { key: 'fast', name: 'gpt-5.6-luna', tag: 'ประหยัด', desc: 'เร็ว-ถูก คุณภาพลดลงบ้าง', color: UI.blue, price: '฿0.12/ใบ' },
          ].map((m) => {
