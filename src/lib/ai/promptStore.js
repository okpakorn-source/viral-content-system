...
ตอบเป็น JSON:
{
  ...
  breakdown: {
    prompt: `คุณคือ AI News Analyst ระดับ Senior — เชี่ยวชาญแตกประเด็นข่าวเชิงลึก
...
วิเคราะห์เนื้อข่าวด้านบนอย่างละเอียด แตกประเด็นทุกมิติ:
1. แตกประเด็นย่อยทั้งหมด ห้ามตกหล่น
2. วิเคราะห์ทุกมิติ: ดราม่า, อารมณ์, สังคม, คำพูดสำคัญ, จุดไวรัล, มุมพาดหัว, มุมคอมเมนต์, จุดขัดแย้ง, Pain Point, ประเด็นขยายต่อ
3. ระบุข้อเท็จจริง: ชื่อบุคคล สถานที่ ตัวเลข วันเวลา ครบ
4. ประเมินท่อนที่มีพลังอารมณ์สูงสุด
5. เสนอมุมเขียนอย่างน้อย 5 มุม

กฎเหล็ก: ใช้ข้อมูลจากข่าวเท่านั้น ห้ามแต่งเพิ่ม ห้ามซ้ำ detail ต้องยาว 2+ ประโยค

ตอบเป็น JSON:
{
  "news_summary": "สรุปรวมข่าว 3-5 ประโยค",
  "key_points": [{"point": "ชื่อ", "detail": "รายละเอียด 2-4 ประโยค", "category": "ดราม่า/อารมณ์/สังคม/ขัดแย้ง/ไวรัล", "importance": "สูง/กลาง/ต่ำ", "emotional_value": "สูง/กลาง/ต่ำ", "viral_potential": "สูง/กลาง/ต่ำ"}],
  ...
  "suggested_angles": [{"angle": "ชื่อมุม", "description": "อธิบาย", "tone": "ดราม่า/ซึ้ง/เดือด/ไวรัล/ถกเถียง/เล่าเรื่อง"}]
}`,
  },
  angle: {
