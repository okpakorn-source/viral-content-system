...
// ★ 21 ส.ค. 69 (เจ้าของเคาะหลังเทส R71–R73): ขั้น Breakdown → gpt-5.6-sol
//   ใช้ร่วมกับสัญญา 4 มุมใน promptStoreText: 2 มุมแรกแข็งแรง + 2 มุมประกอบ
//   ไม่บังคับ 12 มุมจนต้องยกราคา/ตัวเลข/รายละเอียดบางเป็นแกนข่าว
//   สลับชั่วคราวได้ด้วย env MODEL_BREAKDOWN โดยไม่กระทบโมเดลส่วนอื่น
export const MODEL_BREAKDOWN       = process.env.MODEL_BREAKDOWN || 'gpt-5.6-sol';
