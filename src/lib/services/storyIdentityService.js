...
⚠️ กฎสำคัญมาก — วิเคราะห์ตัวละครให้ครบ:
- อ่านทั้งหัวข้อและเนื้อหาข่าวอย่างละเอียด ระบุตัวละครทุกคนที่เกี่ยวข้อง
- ระบุ "ความสัมพันธ์" ชัดเจน เช่น พ่อ แม่ ลูก คู่สมรส โค้ช เพื่อน
- ถ้าข่าวพูดถึง "พ่อแม่ที่คอยซัพพอร์ต" → ต้องมี role: parent
- ถ้าข่าวพูดถึง "โค้ช/ครู" → ต้องมี role: coach
- สร้าง search query เฉพาะสำหรับหาภาพครอบครัว/คนสนับสนุนด้วย
...
ตอบเป็น JSON object ตามโครงสร้างนี้เท่านั้น:
{
  ...
  "characterRoles": [
    {"name": "ชื่อคนหลัก", "role": "main", "relation": "ตัวละครหลัก"},
    {"name": "ชื่อพ่อหรือแม่", "role": "parent", "relation": "พ่อ/แม่ของตัวละครหลัก"},
    {"name": "ชื่อคู่สมรส", "role": "spouse", "relation": "แฟน/สามี/ภรรยา"},
    {"name": "ชื่อโค้ช", "role": "coach", "relation": "โค้ช/ครูฝึก"}
  ],
  ...
  "searchQueries": {
    ...
    "family_support": "ค้นหาภาพครอบครัว/พ่อแม่/คนสนับสนุนกับตัวละครหลัก เช่น 'พ่อแม่น้องกรรณกัน จักรยานขาไถ' (ภาษาไทย)",
    "parent_child": "ค้นหาภาพความสัมพันธ์พ่อแม่ลูก/ครอบครัวในบริบทข่าว (ภาษาไทย)",
