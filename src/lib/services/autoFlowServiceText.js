...
หากไม่มีเนื้อหาเพิ่มเติม ให้ผลลัพธ์เป็น: newsTitle="คลิป TikTok (${domain})", newsBody="ไม่สามารถดึงเนื้อหาอัตโนมัติได้ กรุณาวางลิงก์แบบเต็มหรือพิมพ์เนื้อหาเอง"`.trim();
  ...
  // ★ ปรับ 12 มิ.ย. (feedback ทีม: "ทุกข่าวเปิดสูตรเดียวกันจนดูประดิษฐ์"): จากสไตล์บังคับ → คำแนะนำที่เลือกเองได้
  //   + กฎความเป็นธรรมชาติ/ตรรกะ (เคส #00206 "พัดลมหมุนเพราะชายเพิ่งจากไป" = เปิดสวยแต่ผิด logic)
