...
`;
    ...
    let multiPrompt = prompt + '\n\n=== คำสั่งสำคัญสำหรับการเขียน ===\n' +
      ...
      '- ต้องมีโครงสร้าง: เปิดเรื่อง(hook) → เล่าเรื่อง → รายละเอียด → ปิดด้วยประโยคบรรยายเรียบๆ ที่บอกเล่าความจริงโดยไม่ตีความหมายเพิ่มเติม\n' +
      ...
      '2. ย่อหน้าสุดท้ายกระชับ — ปิดท้ายไม่เกิน 2 ประโยค ไม่เฟ้อ ไม่ออกทะเล ไม่สรุปข้อคิดชีวิต ไม่วิเคราะห์เพิ่ม\n' +
      ...
      '❤️🔥 POSITIVE FLOW RULE (ห้ามละเมิด):\n' +
      '- ห้ามใช้ "แม้จะ...แต่ก็...", "ถึงแม้...ก็ยัง...", "แม้...แต่...", "ไม่ใช่...แต่เป็น..." เป็น connector\n' +
      '- ห้ามสร้าง tension แล้ว resolve ในประโยคเดียว\n' +
      '- เขียนตรงๆ ("เขาเลือกทำสิ่งที่ยากกว่า") แทนการเปรียบ ("แม้จะมีทางง่ายกว่า แต่เขากลับเลือก")\n' +
      '- ถ้าข่าวเป็นแง่ลบ ให้เล่าด้านดีตรงๆ ไม่ต้องเริ่มด้วยการบอกว่าแง่ลบ\n' +
      '=== จบ QUALITY RULES ===\n\n' +
