...
`;
    ...
    let multiPrompt = prompt + '\n\n=== คำสั่งสำคัญสำหรับการเขียน ===\n' +
      (targetCount === 1
        ? 'คุณต้องสร้างเนื้อหา 1 เวอร์ชันที่ "ดีที่สุด" จากข่าวนี้ โดยเล่าตามมุมเล่าบังคับ (FOCUS ANGLE) อย่างเคร่งครัด\n'
      ...
      (targetCount === 1
        ? `สร้าง 1 เวอร์ชัน: เทพลังทั้งหมดไปที่เวอร์ชันเดียวให้ดีที่สุด ตามมุมเล่าบังคับ\n\n`
