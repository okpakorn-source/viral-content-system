...
import { MODEL_PRIMARY, MODEL_FAST, MODEL_HEAVY_FALLBACK } from '@/lib/ai/era/modelConfig';
...
ตอบเป็น JSON: { "selectedIndex": <1-5>, "reason": "..." }`;
              ...
              const { callGemini, isGeminiAvailable } = await import('@/lib/ai/era/geminiClient');
