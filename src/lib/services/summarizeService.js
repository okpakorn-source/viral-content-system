...
`;
    ...
    let multiPrompt = prompt + '\n\n=== คำสั่งสำคัญสำหรับการเขียน ===\n' +
      ...
      `แต่ละเวอร์ชัน:\n` +
      `- ${process.env.LENGTH_BY_CONTENT === '0' ? `ความยาวบังคับ ${lenCfg.min}-${lenCfg.max} คำ` : `ความยาว: เล่าให้ครบทุกประเด็นสำคัญจากต้นฉบับเป็นหลัก สูงสุดไม่เกิน ${lenCfg.max} คำ — เนื้อน้อยเขียนสั้นได้ ห้ามยืดความ/เติมสิ่งที่ต้นฉบับไม่มีเพื่อให้ยาวขึ้น`} ทุกประโยคต้องให้ข้อมูลใหม่ แบ่ง ${lenCfg.paraDesc} เป๊ะสำหรับ Facebook — ห้ามเกินจำนวนนี้ ประโยคปิดต้องอยู่ท้ายย่อหน้าสุดท้าย ห้ามแยกออกเป็นย่อหน้าใหม่\n` +
