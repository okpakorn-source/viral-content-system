...
`;
    ...
    let multiPrompt = prompt + '\n\n=== คำสั่งสำคัญสำหรับการเขียน ===\n' +
      ...
      '13. ★ ห้ามคำเหมารวมสุดโต่งที่ข่าวไม่ได้ยืนยัน: "ทุกบาท" "ไม่เคย...เลย" "ทั้งชีวิต" "ไม่เหลืออะไรติดตัว" — ใช้คำแม่นกว่า: "เกือบทั้งหมด" "ส่วนใหญ่" "ต่อเนื่องหลายปี" (จับได้จริง: "ใช้เงินทุกบาทที่หามาได้ไปช่วยคนอื่น" = เวอร์เกินข่าว)\n' +
      '14. ★ คำกริยา/หน่วยต้องแม่นกับข้อเท็จจริง: ของถูก "ลืมไว้" ไม่ใช่ "หล่นหาย" | เหตุการณ์ต่างประเทศใช้สกุลเงินตามข่าว (เหรียญไต้หวัน ไม่ใช่บาท) | ห้ามตีความการกระทำเกินที่ข่าวระบุ\n' +
      '15. ★ ตัวเลขแจกแจงต้องบวกลงตัวกับยอดรวม — ถ้าต้นฉบับแจกแจงไม่ครบยอด ให้เขียน "ส่วนที่เหลือสมทบ..." หรือเล่าเฉพาะก้อนที่รู้ ห้ามปล่อยให้คนอ่านบวกแล้วงง (จับได้จริง: บอก 46.5 ล้าน แต่แจกแจง 37+9 = 46 หาย 0.5 ล้าน)\n' +
      '16. ★ เปรียบเปรยได้เมื่อเป็นธรรมชาติเท่านั้น — ห้ามสำนวนประดิษฐ์ ("ทุกอย่างวิ่งเป็นระบบเหมือนต่อจิ๊กซอว์") ห้ามดราม่าตัดสิน/เหมารวมกลุ่มคน ("เด็กที่โตมาแบบขาดพ่อมันไม่ดี") — ประโยคไหนอ่านแล้วรู้ว่า "เขียนเอาสวย" ให้ตัดทิ้งแล้วเล่าตรงๆ แบบคนเล่าให้เพื่อนฟัง\n' +
      '17. ★ ทุกเวอร์ชันต้องมี "เสียงคนจริง" อย่างน้อย 1 จุดถ้าต้นฉบับมีให้ใช้ — คำพูดตรงในเครื่องหมายคำพูด หรือรายละเอียดมนุษย์เฉพาะเจาะจง (ท่าทาง เมนู ราคา เวลา พิกัด) — ข่าวที่ไม่มีเสียงคนจริงเลยอ่านแล้วเหมือนสรุปข่าว ไม่ใช่เรื่องเล่า (ตัวอย่างไวรัลจริงของเพจมีทุกโพสต์)\n' +
      '18. ★ น้ำเสียง = "แอดมินเพจเล่าให้แฟนเพจฟัง" ไม่ใช่นักข่าว/นักเขียนนิยาย — โพสต์ 9,000 แชร์จริงของเพจ: เรียกคนในข่าวแบบมีความสัมพันธ์เมื่อเหมาะ (พี่จา, ลุงบอล, น้องเพนนี), พูดกับคนอ่านได้ ("ใครจะคิดว่า..."), และข่าวบวก/สู้ชีวิตปิดท้ายด้วยส่งกำลังใจ-อวยพรสั้นๆ ได้ ("ขอให้พี่หายไวๆ นะ") — อบอุ่นจริงใจ ไม่ใช่ละคร\n\n' +
