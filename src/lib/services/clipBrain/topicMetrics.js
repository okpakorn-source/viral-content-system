...
export const STYLE_WORDS = Object.freeze({
  ...
  // ★ วงตรวจ 9 ก.ย.: ตัด ทันที/ชัดเจน/ตรงๆ/อย่างมาก/อย่างยิ่ง ออกจากด่านแข็ง (เป็นคำบอกเวลา/ระดับที่ข่าวข้อเท็จจริงใช้จริง เช่น "เสียชีวิตทันที") เหลือเฉพาะคำเร้าอารมณ์ชัดๆ
  dramatic: Object.freeze(['ถึงกับ', 'เหนียวแน่น', 'น้ำตาคลอ', 'สะเทือนใจ', 'ซาบซึ้ง', 'สุดซึ้ง', 'ใจสลาย', 'อบอุ่นหัวใจ', 'สุดยอด', 'เหลือเชื่อ', 'ไม่น่าเชื่อ', 'น่าทึ่ง', 'สุดๆ', 'ท่วมท้น', 'ปลื้มปริ่ม', 'น่าประทับใจ', 'อย่างน่าอัศจรรย์', 'น้ำตาซึม', 'สุดหัวใจ']),
  // ★ วงตรวจ 9 ก.ย.: ตัด พยายาม/กลายเป็น/ไปหมด ออก (ตัดแล้วความเปลี่ยน: "พยายามติดต่อ" ≠ "ติดต่อ")
...
export function styleIssues(report, { level = 'all' } = {}) {
  ...
  if (r.attribution > 0) hard.push(`อ้างที่มาในเนื้อเรื่อง ${r.attribution} ครั้ง (${show(r.matches.attribution)}) — เล่าเป็นเหตุการณ์โดยตรง หรือย้ายไปฟิลด์ quotes`);
