...
// ★ 19 มิ.ย. (เก็บกว้าง — ผู้ใช้สั่งปลดล็อก): เหลือเฉพาะ "ขยะยูทิลิตี้" ที่ไม่ใช่ข่าวคอนเทนต์เลย
//   (อากาศ/ทีเด็ดบอล/ราคาหุ้น-ทอง-คริปโต/หวย) — ปลดบล็อก ดราม่า/ราชการ/เศรษฐกิจ/คนไทยต่างแดน (เก็บไว้ติดหมวด)
...
export const DESK_CATEGORIES = [
  'กระแสรายวัน', // ★ 19 มิ.ย. รอบ 2: กระแสโซเชียลรายวัน — มาก่อนเป็นอันดับแรก (ผู้ใช้สั่ง)
  'น้ำใจ/ช่วยเหลือ', 'กตัญญู/ครอบครัวอบอุ่น', 'สู้ชีวิต', 'คนดังทำดี/ติดดิน',
  'สัมภาษณ์/บทสนทนาดี', 'บันเทิงกระแส', 'คนดัง/ดราม่าบันเทิง', 'ดราม่าสังคม', 'เตือนภัย/อุทาหรณ์',
  // ★ 19 มิ.ย. (เก็บกว้าง): หมวดเพิ่มครอบข่าวไทยทุกแนว
  'ความรัก/แต่งงาน', 'อาชญากรรม/คดีดัง', 'กีฬา', 'ไลฟ์สไตล์/ไวรัล', 'อื่นๆ',
];
...
// ════════════════════════════════════════════════════
// ★ 19 มิ.ย. (เก็บกว้าง): จัดหมวด + กรอง gore แบบ "คีย์เวิร์ด" (ฟรี ไม่ใช้ AI)
//   ใช้กับเลน broad ที่ปริมาณเยอะ — จัดหมวดเร็ว/ฟรี ไม่ต้องยิง OpenAI ทีละ 10 ข่าว
// ════════════════════════════════════════════════════
const KW_CAT_RULES = [
  ['ความรัก/แต่งงาน', /แต่งงาน|วิวาห์|งานหมั้น|จดทะเบียนสมรส|ขอแต่งงาน|ควงแฟน|คู่รัก|ตั้งครรภ์|คลอด|รับขวัญ|ฉลองรัก|ครบรอบรัก|สละโสด/],
  ['กตัญญู/ครอบครัวอบอุ่น', /กตัญญู|ดูแลแม่|ดูแลพ่อ|เลี้ยงดูพ่อแม่|ครอบครัวอบอุ่น|ลูกกตัญญู|ซื้อบ้านให้แม่|ซื้อรถให้แม่|พาแม่|พาพ่อ/],
  ['น้ำใจ/ช่วยเหลือ', /น้ำใจ|ช่วยเหลือ|ช่วยชีวิต|บริจาค|พลเมืองดี|คืนเงิน|คืนของ|กู้ภัย|ระดมทุน|ทำบุญ|ยื่นมือ/],
  ['คนดังทำดี/ติดดิน', /ดาราใจบุญ|ดาราติดดิน|คนดัง.{0,6}บริจาค|ยกที่ดิน|สร้างบ้านให้|ใช้หนี้ให้|สละ.{0,6}ช่วย/],
  ['สู้ชีวิต', /สู้ชีวิต|ไม่ยอมแพ้|ฝ่าฟัน|พลิกชีวิต|จากศูนย์|ตั้งตัว/],
  ['กีฬา', /ฟุตบอล|วอลเลย์บอล|นักกีฬา|ทีมชาติ|เหรียญทอง|แบดมินตัน|มวย|ซีเกมส์|โอลิมปิก|อีสปอร์ต/],
  ['อาชญากรรม/คดีดัง', /คดี|จับกุม|มิจฉาชีพ|หลอกลวง|ฉ้อโกง|โกงเงิน|ปล้น|ลักทรัพย์|ตุ๋น|แก๊งคอล|ออกหมายจับ|รวบ/],
  ['เตือนภัย/อุทาหรณ์', /อุทาหรณ์|เตือนภัย|ระวัง|อันตราย|เตือน/],
  ['สัมภาษณ์/บทสนทนาดี', /สัมภาษณ์|เปิดใจ|เปิดอก|ให้สัมภาษณ์/],
  ['ความรัก/แต่งงาน', /เลิกกัน|เลิกรา|อกหัก|ขอเลิก/],
  ['คนดัง/ดราม่าบันเทิง', /ดารา|นักร้อง|นักแสดง|ไอดอล|พิธีกร|ซุปตาร์|เซเลบ|นางเอก|พระเอก|ศิลปิน/],
  ['ดราม่าสังคม', /ดราม่า|ชาวเน็ต|ทัวร์ลง|วิจารณ์|ถล่ม|ปะทะคารม|แฉ/],
  ['ไลฟ์สไตล์/ไวรัล', /ไวรัล|คลิป|ยูทูบเบอร์|ติ๊กต็อก|tiktok|รีวิว|เน็ตไอดอล|อินฟลู/i],
  ['บันเทิงกระแส', /หนัง|ละคร|ซีรีส์|คอนเสิร์ต|เพลงใหม่|อัลบั้ม|ภาพยนตร์|\bMV\b/i],
];
export function keywordCategorize(item) {
  const t = `${item.title || ''} ${item.snippet || ''}`;
  for (const [cat, re] of KW_CAT_RULES) { if (re.test(t)) return cat; }
  return 'อื่นๆ';
}
// ★ กรอง "รุนแรง/สยอง" (เพิ่มจาก BANNED) — safety floor ที่ผู้ใช้สั่ง: ตัดผิดกฎหมาย + รุนแรง/สยอง
const GORE_RE = /ฆาตกรรม|ฆ่าโหด|หั่นศพ|ชำแหละ.{0,4}ศพ|ศพ.{0,6}(เน่า|อืด|เปื่อย)|เลือดท่วม|สยองขวัญ|ดับอนาถ|แขวนคอ.{0,4}(ตาย|ดับ)|ผูกคอ.{0,4}(ตาย|ดับ)|กระโดด.{0,4}(ตึก|สะพาน).{0,6}(ดับ|ตาย|จบชีวิต)|เผาทั้งเป็น|รุมประชาทัณฑ์|ยิงดับ|แทงดับ|ฟันดับ|จ่อยิง/;
export function keywordGore(item) {
...
export async function classifyBatch(items) {
  ...
  const _runChunk = async (chunk) => {
    ...
    const _isClipItem = (it) => !!(it.isVideo || it.lane === 'clip' || it.lane === 'video' || it.lane === 'interview'
      || /youtube\.com|youtu\.be|tiktok\.com|instagram\.com|fb\.watch|facebook\.com\/(reel|watch)/i.test(String(it.url || '')));
    const list = chunk.map((it, idx) => {
      let domain = '';
      try { domain = new URL(it.url || '').hostname; } catch {}
      const tag = _isClipItem(it)
        ? `🎬คลิป${it._clipPlatform ? '-' + it._clipPlatform : (it.sourceType ? '-' + it.sourceType : '')}`
        : `📰${domain}`;
      return `${idx}: [${tag}] ${String(it.title || '').slice(0, 120)} | ${String(it.snippet || '').slice(0, 150)}`;
    }).join('\n');
    try {
...
- ★★★ remakeable (26 มิ.ย. — สำคัญสุด ผู้ใช้สั่ง): "ข่าวนี้หยิบมาทำคอนเทนต์ใหม่ได้จริงไหม วันไหนก็ได้" = true/false
  เกณฑ์ชี้ขาด → ถามตัวเอง: "ถ้าโพสต์เรื่องนี้วันนี้ โดยไม่ต้องอ้าง 'เมื่อวาน/ดราม่าที่เพิ่งเกิด/เหตุการณ์ที่ผ่านไป' แล้วคนยังอิน + เป็นคอนเทนต์ที่ดูได้ → remakeable=true"
  · ✅ true = เรื่องของ "คน" ที่มีสตอรี่เล่าได้เรื่อยๆ: เส้นทางชีวิต/จากศูนย์สู่สำเร็จ/สู้ชีวิต/กตัญญูดูแลพ่อแม่/ช่วยเหลือคน(ปัญญาปันสุข, ฮีโร่ชีวิตจริง)/ชื่นชมคนดี/แรงบันดาลใจ/สัมภาษณ์เปิดใจชีวิต — มีคนเป็นตัวเอก + มีประเด็นลึกพอเล่าได้ (ชาวบ้านธรรมดาที่มีเรื่องดีๆ = เอา)
  · ❌ false = (1) ดราม่า/กระแสที่จบไปแล้ว เล่นใหม่ไม่ได้ (2) เหตุการณ์ผูกเวลาที่ผ่านไปแล้ว: แถลงข่าว/ประกาศ/เปิดตัว/งานอีเวนต์/ผลรางวัลวันนั้น (3) ไม่มีคนเป็นตัวเอก: ข่าว PR บริษัท/โปรโมชั่น/สถิติ/ลิสต์รวม/นโยบาย-การเมือง/หน่วยงาน (4) เรื่องตื้นๆ ไม่มีประเด็นให้เล่าต่อ
  · ⚖️ ไม่แน่ใจ → ดูว่า "มีคน + มีสตอรี่ที่กินใจ/น่าสนใจไหม" ถ้ามี=true ถ้าเป็นแค่เหตุการณ์/ข้อมูล=false
- ★★★ clipWorthy (2 ก.ค. — เฉพาะรายการที่ขึ้นต้น 🎬คลิป): "คลิปนี้เอามาทำข่าวได้ไหม" = true/false
  · ✅ true = คลิปที่มีประเด็น/เรื่องราว/การกระทำที่เล่าเป็นข่าวได้ — ★ รวม "คลิปที่พูดน้อยแต่การกระทำสื่อความหมาย/มีประเด็น" (ไฮไลท์กีฬา/โมเมนต์ประทับใจ/สิ่งที่ทำ/ปฏิกิริยา/เหตุการณ์ในคลิป) เพราะเรามี AI ถอด+อธิบายคลิปได้ · สัมภาษณ์/เปิดใจ/เล่าเรื่องชีวิต = true แน่นอน
  · ❌ false = คลิปไร้เนื้อหาทำข่าว: โปรโมท/ขายของ/รีวิวสินค้า/เต้น cover เฉยๆ/ตัวอย่างหนัง-MV/คลิปสั้นไร้ประเด็น
  · รายการที่ขึ้นต้น 📰 (บทความ ไม่ใช่คลิป) → clipWorthy=false เสมอ (ฟิลด์นี้ไม่เกี่ยวกับบทความ)
- field เพิ่ม: การศึกษา=ครู/อาจารย์ | ศาสนา=พระ/เกจิ | สายมู=หมอดู/ดวง`,
        model: 'gpt-4o-mini',
        temperature: 0.1,
        maxTokens: 1500,
      });
      ...
      for (const r of parsed?.items || []) {
        ...
        out.push({
          ...
          // ★ 26 มิ.ย. (ผู้ใช้สั่ง): "ทำใหม่ได้ไหม" — default true (กันตัดเกินตอน AI ไม่ตอบ) · ตัดเฉพาะที่ฟันธงว่า false
          remakeable: r.remakeable !== false,
          // ★ 2 ก.ค.: คลิปนี้ทำข่าวได้ไหม (รวมคลิปพูดน้อยแต่การกระทำมีประเด็น) — เฉพาะคลิป · บทความ = false
          clipWorthy: r.clipWorthy === true,
...
export const SPECIALIST_EDITORS = {
  ...
  //   จับข่าวพลเมืองดี/ช่วยเหลือคน/ปัญญาปันสุข/ชาวบ้านน้ำใจงาม + ข่าวทั่วไปที่ค้นเจอกว้างๆ ไม่ให้หลุด
  citizen: {
    name: 'บก.พลเมืองดี/ทั่วไป',
    icon: '🧑‍🌾',
    lanes: ['broad', 'exa'],
    persona: 'คุณคือ บก.สายพลเมืองดี/ข่าวทั่วไป เชี่ยวชาญข่าว "คนธรรมดาทำเรื่องดี" — ช่วยเหลือคน/บริจาค/ปัญญาปันสุข/คลิปน้ำใจ/ชาวบ้านสู้ชีวิต/ฮีโร่ไม่มีชื่อเสียง รู้ว่าข่าวแนวนี้ปังเพราะ "ตัวละครจริง+สตอรี่กินใจ" ไม่ใช่แค่เหตุการณ์ลอยๆ คัดเฉพาะที่มีคน+มีเรื่องเล่า ตัดข่าวที่เป็นแค่ข้อมูล/ประกาศ/คนโพสต์เฉยๆ ไม่มีสตอรี่ทิ้ง',
  },
};
...
const CAT_GROUP = {
  ...
  'บันเทิงกระแส': 'neutral', 'คนดัง/ดราม่าบันเทิง': 'neutral', 'อื่นๆ': 'neutral', 'กระแสรายวัน': 'neutral',
  'ความรัก/แต่งงาน': 'positive', 'กีฬา': 'neutral', 'ไลฟ์สไตล์/ไวรัล': 'neutral',
  'ดราม่าสังคม': 'drama', 'อาชญากรรม/คดีดัง': 'warn', 'เตือนภัย/อุทาหรณ์': 'warn',
};
