...
`;
    ...
    let multiPrompt = prompt + '\n\n=== คำสั่งสำคัญสำหรับการเขียน ===\n' +
      ...
      // ★ 16 ส.ค. 69 (วิธี D): ตัวอย่าง ✅ เดิมสอนโครง "ตัวเลขขึ้นก่อน" ซึ่งเป็นต้นแบบของประโยคฝืน
      //   ("เกษียณตอนอายุ 42 พร้อมบำนาญ..." → นักเขียนลอกเป็น "เกรด 4.00 มาตลอด แต่...")
      //   หลักฐาน: โพสต์ไวรัลจริง 71 ใบในหอสมุด เปิดด้วยตัวเลขเป็นคำแรกแค่ 1 ใบ (1%)
      (process.env.HOOK_STYLE_MODE !== 'off'
        ? '9. ★ ประโยคแรกของทุกเวอร์ชันต้องเป็น "ประโยคสมบูรณ์" และต้องขึ้นต้นด้วย "คนหรือการกระทำ" ไม่ใช่ตัวเลข — ❌ ห้ามขึ้นต้นด้วยตัวเลข/หน่วยวัดลอยๆ ("เกรด 4.00 มาตลอด แต่..." · "ยอดขายเดือนละ 30 ล้าน คือ..." · "อายุ 42 เขาคือจ่าโอ...") ✅ บอกก่อนว่าใคร แล้วค่อยวางตัวเลขกลางประโยค ("พี่ป๋อ กับ พี่เอ๋ อยู่กินกันมา 18 ปี..." · "พวกเรารู้กันดีว่าพี่กุ้งรักษาน้องวิไปเกิน 10 ล้าน...") — นี่คือรูปประโยคของโพสต์แสนไลก์จริงในหอสมุด 71 ใบ\n'
