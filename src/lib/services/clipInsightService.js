...
export function currentInsightPromptRev() {
  ...
  return swOn('CLIP_STYLE_DIRECT') ? `${base}-direct` : base; // ★ 8 ส.ค.: ภาษาเล่าตรงกรอบเทา (เจ้าของสั่ง)
}
...
const GRAY_DIRECT_RULES = `★★ ภาษาเล่าตรง ไม่มีคำเปรยพิธีการ (ใช้กับ rawData รวม + subStories + ทุกช่องเนื้อความ)
- คำเปรยพิธีการทุกชนิดไม่ใช่เนื้อเรื่อง ห้ามใช้ในเสียงผู้เล่า: เปิดใจ เผยว่า เปิดเผยว่า กล่าวว่า ออกมาเผย เปิดใจผ่านรายการ... เล่าในรายการ...ว่า กล่าวในรายการ ระหว่างการสัมภาษณ์
...
- ชื่อรายการหรือผู้ดำเนินรายการ เอ่ยได้มากที่สุดหนึ่งครั้งแบบสั้น หรือไม่เอ่ยเลยก็ได้ หลังจากนั้นห้ามพูดถึงรายการ พิธีกร หรือการสัมภาษณ์อีก เว้นแต่คำถามหรือเหตุในรายการเป็นสาระของเรื่องเอง
