...
export const CLIP_EDITORIAL_RAW_REV = 'clip-editorial-voice-v8-0909';
...
★★ เสียงคนเล่า (ใช้กับ rawData และ subStory.rawData ทุกก้อน — เนื้อดิบถูกใช้เขียนข่าวตรงๆ ต้องอ่านลื่นเหมือนคนที่รู้เรื่องนี้ดีเล่าให้เพื่อนฟัง ไม่ใช่นักข่าวรายงานถึงเขา):
- เล่าเป็นเหตุการณ์ตรงๆ ห้ามกริยารายงานกลางเรื่อง: ระบุว่า / ยังระบุอีกว่า / เผยว่า / กล่าวว่า / เล่าว่า / บอกว่า / ยอมรับว่า — สิ่งที่เจ้าของเรื่องพูดให้เขียนเป็นเหตุการณ์หรือความรู้สึกของเขาโดยตรง คำพูดคำต่อคำแยกไปไว้ quotes
  ✗ "โดยมิคระบุว่าเหตุการณ์เกิดขึ้นหลังมีลูกคนแรก ตนรู้สึกเหมือนเป็นเพียงคนหาเงิน" → ✓ "หลังมีลูกคนแรก มิครู้สึกเหมือนเป็นแค่คนออกไปหาเงินเข้าบ้าน กลับถึงบ้านก็ไม่มีใครเห็นตัวตน"
- ห้ามสรรพนามทางการ: ตน / ตนเอง / บุคคลดังกล่าว / ฝ่ายชาย / ฝ่ายหญิง / ทั้งสองฝ่าย → ใช้ชื่อคน หรือละประธานเมื่อประโยคต่อเนื่องจากประธานเดิม ("เจ้าตัว" ใช้เท่าที่จำเป็นตามกฎหลักฐานตัวตน)
- ชื่อคนอย่าซ้ำทุกประโยค: เอ่ยชื่อ-นามสกุลเต็มครั้งแรกครั้งเดียว จากนั้นใช้ชื่อสั้นสลับกับละประธาน — ภาษาไทยละประธานได้และลื่นกว่า
- ห้ามคำเปลืองแบบเอกสาร: ดังกล่าว / ทั้งนี้ / อย่างไรก็ตาม และการร้อยประโยคยาวด้วย โดย/ซึ่ง/จึง ซ้อนกันหลายชั้น — ให้ไหลด้วยคำเชื่อมแบบพูด (พอ…ก็ / แต่ / เลย / จน / เพราะ) เมื่อเชื่อมเหตุ-ผลจริง
- เล่าต่อเนื่องเป็นเรื่องเดียวจนจบ: ย่อหน้าใหม่คือตอนถัดไปของเรื่องเดิม ต่อจากประโยคก่อนหน้าได้เลย — ห้ามเปิดย่อหน้าเหมือนเริ่มข่าวใหม่ (ซ้ำชื่อเต็ม+บริบทเดิม หรือขึ้นด้วยคำสรุปอย่าง "ความรู้สึกดังกล่าวสะสม…")
- จังหวะประโยคสลับสั้น-ยาว อย่าขึ้นต้นประโยคหรือย่อหน้าด้วยรูปแบบเดิมซ้ำแถว`;
