...
const currentPromptRev = () => {
  ...
  return swOn('CLIP_SMART_ORDER') ? `${withStyle}-order1` : withStyle; // ★ 10 ส.ค.: ประโยคเปิดเป็นใจความข่าว
};
...
// ★ 10 ส.ค.: เปิดโหมดประโยคเปิดเป็นใจความข่าว = ต้องกันตัวขัดเกลาไปรื้อประโยคเปิดทิ้ง
...
// ★ ผู้ตรวจ Sol 10 ส.ค. ข้อ 3: ฝั่งเขียว "ประกาศแทนที่" อย่างเดียวไม่พอ คำสั่งเรียงเวลาเดิมยังอยู่
//   โดยเฉพาะบรรทัดตรวจท้ายพรอมต์ซึ่งมาทีหลังบล็อกใหม่ → กฎเก่ามีโอกาสชนะ ต้องแก้ถ้อยคำตรงจุดเหมือนฝั่งเทา
