...
export class MasterAgent {
  ...
  compileContext(options = {}) {
    ...
    // 7. คำสั่งเหล็ก
    ctx += `⚠️ คำสั่งเหล็ก: ใช้ข้อมูลทั้งหมดข้างต้น ห้ามแต่งเพิ่ม ห้ามตัดข้อมูลสำคัญ เขียนยาวอย่างน้อย 250 คำ หรือ 3 ย่อหน้าเต็มสำหรับ Facebook (แต่ละย่อหน้า 3-5 ประโยค คั่นด้วย \\n\\n)\n โครงสร้าง: [ย่อหน้า 1] เปิดแรง hook ดึงอารมณ์ → [ย่อหน้า 2] เล่ารายละเอียด storytelling เนื้อหาเยอะ → [ย่อหน้า 3] ปิดด้วยคำถามหรือประโยคทิ้งท้ายกระตุ้นคอมเมนต์\n`;
