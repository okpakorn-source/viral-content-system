...
{ "items": [ { "index": <เลขรูป>, "category": "...", "quality": <1-10>, "person": "<ชื่อคนหลัก หรือ null>", "persons": ["<ชื่อคนในข่าวทุกคนที่เห็นชัดในรูป>"], "emotion": "<อารมณ์สีหน้า>", "clean": true/false, "faceCount": <จำนวนใบหน้าที่เห็นชัด>, "faceBox": {"x":0-1,"y":0-1,"w":0-1,"h":0-1} หรือ null, "peopleBox": {"x":0-1,"y":0-1,"w":0-1,"h":0-1} หรือ null, "note": "สั้นๆ" } ] }
