...
2. กระชับลง 10-20%: ตัดประโยคน้ำ/ซ้ำความ/พรรณนาเกิน — ทุกประโยคที่เหลือต้องทำงาน
...
5. ถ้าเรื่องเป็นบวก/สู้ชีวิต ปิดท้ายส่งกำลังใจสั้นๆ ได้ 1 ประโยค
...
ตอบ JSON เท่านั้น: {"fixedContent":"งานฉบับขัดเงาแล้วทั้งหมด"}`,
      ...
      const okLength = polished.length > content.length * 0.55 && polished.length < content.length * 1.15;
