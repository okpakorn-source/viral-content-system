...
const PUBLIC_ROUTES = ['/login', '/cover-tester', '/image-search', '/news-filter', '/clip-transcript', '/photo-enhance', '/casting', '/casting/admin', '/news-desk']; // ★ 4 ก.ค.: /image-search คู่กับ /cover-tester · 7 ก.ค.: /news-desk เปิดให้พนักงานหาข่าวผ่านลิงก์ตรง
