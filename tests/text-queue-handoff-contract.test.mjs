...
// ★ 23 ก.ย. 69 (แคมเปญแก้บั๊ก ข้อ 1 · เจ้าของอนุมัติ) — CFG-08: การแก้ 2 ก.ย. ข้างบน (525dd988) ถูก restore 7 ก.ย. (a313281c)
//   ย้อนทิ้งไปพร้อมระบบข่าว 27 ส.ค. → แดงค้างบน main อีก 16 วัน · คืน normalize เดิมทุกตัวอักษร (ด่าน npm run test:news กันซ้ำ)
