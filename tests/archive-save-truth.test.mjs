...
// ★ 23 ก.ย. 69 (แคมเปญแก้บั๊ก ข้อ 1 · เจ้าของอนุมัติ) — CFG-02: การแก้ 2 ก.ย. ข้างบน (525dd988) ถูก restore 7 ก.ย. (a313281c)
//   ย้อนกลับเป็นเทสรุ่น 27 ส.ค. (slice ถึง POST) → แดง 6/7 ค้างบน main 16 วัน ทั้งที่โค้ด route/newsArchiveService ปัจจุบัน
//   ยังเป็นสัญญาเดียวกับที่การแก้ 2 ก.ย. เขียนไว้ (saveToArchiveServerSide → saveNewsArchive) · คืนรุ่น 2 ก.ย. ทุกตัวอักษร
//   แล้วทุบซ้ำบนโค้ดปัจจุบัน 23 ก.ย. (M1/M2/M3/M4 แดงตามที่จดไว้ — ผลอยู่ในรายงานแคมเปญ)
