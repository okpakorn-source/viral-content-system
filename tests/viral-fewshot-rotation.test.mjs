...
// ── ⑩ 14 ส.ค. ค่ำ — "สูตรแสนไลก์" เป็นตัวจริง (เจ้าของเคาะ): ไม่ตั้ง=แพ็ค v2 · ถอยกลับ=VIRAL_HITS_FORMULA=0
{
  ...
  // ★ 23 ก.ย. 69 (แคมเปญแก้บั๊ก ข้อ 1 · เจ้าของอนุมัติ) — CFG-02 "เทสตาย": restore 7 ก.ย. (a313281c) ย้อนข้อ 25/26 กลับเป็นรุ่น
  //   27 ส.ค. ที่ตรวจ "VIRAL STYLE PACK v2"/กฎ v2 ซึ่งไม่มีในโค้ดแล้ว (viralFewshot.js ถอด v2 ตั้งแต่ 18 ส.ค.) → ทั้งไฟล์แดง 30/32
  //   ค้างบน main 16 วัน · พฤติกรรมยังอยู่ในรูปใหม่ → คืนข้อ 25/26 รุ่น 2 ก.ย. ที่ตรวจสัญญาปัจจุบันทุกตัวอักษร แล้วทุบซ้ำบนโค้ด
  //   ปัจจุบัน 23 ก.ย. (สลับ _hitsOn ⇒ ข้อ 25 แดง · ปิดการแทน RULE3 ⇒ ข้อ 26 แดง — ผลอยู่ในรายงานแคมเปญ)
